  ...
  <div className="container" id="cv">
    ...
    <section className="row">
      <section className="col-md-12">
        ...
        <p>
            Nedenfor har jeg listet opp teknologier, verktøy og metoder jeg har erfaring med. Utover dette er jeg fortiden interessert i <a href="https://facebook.github.io/react-native/">React Native</a> for utvikling av mobile mobil applikasjoner, <a href="http://graphql.org/">GraphQL</a> som et alternativ til REST og fordeler og ulemper med <a href="http://danluu.com/monorepo/">monorepo</a>.
          </p>
        <dl className="dl-horizontal">
          <dt>Programmeringsspråk</dt>
          <dd>JavaScript (ECMAScript 2015), Scala, Java, C, Groovy, Python, Ruby</dd>
          <dt>Webteknologi</dt>
          <dd>HTML5, CSS3, React, Redux, Immutable.js, SASS, LESS, SVG, Angular.js, Twitter Bootstrap, lodash, Express, Highcharts, jQuery </dd>
          <dt>Webverktøy</dt>
          <dd>Webpack, ESLint, npm, Gulp.js, Livereload/BrowserSync, Karma, Jasmine, Mocha, Grunt, Browserify, RequireJS, Bower</dd>
