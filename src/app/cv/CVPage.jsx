  ...
  <div className="container" id="cv">
    ...
    <section className="row">
      <section className="col-md-12">
        ...
        <p>
          Nedenfor har jeg listet opp teknologier, verktøy og metoder jeg har erfaring med. Utover dette er jeg fortiden interessert i
          {' '}
          ...
          {' '}
          som et alternativ til REST og fordeler og ulemper med
          {' '}
      ...
      <div className="col-md-12">
        ...
        <div className="project">
          ...
          <div className="role">
            <p>
              <b>Rolle: </b>
              Jeg startet som utvikler i prosjektet, og har siden siste halvdel av 2015 vært prosjektleder. I løpet av perioden i KF har jeg vært med på å utarbeide løsningsforslag, estimere, utvikle og levere flere nye webapplikasjoner. Jeg har også jobbet med forvaltning av eksisterende applikasjoner og vært sentral i innføring av en moderne frontendstack.
            </p>

            <p>
              <b>Teknologier: </b>
              Scala, ES2015, React, Redux, Immutable.js, Scalatra, Webpack, npm, SASS, Highcharts, ESLint, Karma, Jasmine/Mocha, Maven
            </p>
          </div>
        </div>
        <div className="project">
        ...
        <div className="project">
          ...
          <div className="role">
            <p>
              <b>Rolle: </b>
              Jeg var del av et frontendteam som var nært knyttet til rammeverksteamet. Teamet var ansvarlig
            ...
            <p>
              <b>Teknologier: </b>
              CSS, Jasmine, Java, JavaScript, Jetty, Less, Maven, Responsivt design, Sonar, Twitter
              Bootstrap, Wicket, jQuery
            </p>
          </div>
        </div>
        <div className="project">
          ...
          <div className="role">
            <p>
              <b>Rolle: </b>
              Jeg var hovedansvarlig for utvikling, ferdigstilling og produksjonssetting av første
              versjon av web-applikasjonen.
            </p>

            <p>
              <b>Teknologier: </b>
              Compass, Grails, Groovy, HTML5, Jasper Reports, JavaScript, LESS, Lucene, Responsive
              Design, Twitter Bootstrap, jQuery
            </p>
          </div>
        </div>
        ...
        <div className="project">
          <h4>
            <span className="pull-right"> 2011 – 2012 </span>
            {' '}
            NAV, Fellessystemer
            {' '}
          </h4>
          ...
          <div className="role">
            ...
            <p>
              <b>Teknologier: </b>
              DB2 Teknologier, ESB, Greenhopper, Hibernate, IBM WebSphere, JSF (Java Server Faces),
        ...
        <div className="project">
          <h4>
            <span className="pull-right"> 2009 – 2011 </span>
            {' '}
            Statens Vegvesen, System for kontroll av kjøretøy (VaDIS)
          </h4>
          ...
          <div className="role">
            ...
            <p>
              <b>Teknologier: </b>
              BlazeDS, Confluence, DWR, Flex, Hibernate, JSP (Java Server Pages), Java 5, JavaScript,
              Maven2, Spring, Struts, jQuery UI
            </p>
        ...
        <div className="project">
          <h4>
            <span className="pull-right"> 2007 – 2008 </span>
            {' '}
            Mattilsynet, MATS
            {' '}
          </h4>
    ...
    <section className="row">
      <div className="col-md-12">
        ...
        <dl className="dl-horizontal">
          ...
          <dd>
            Universitet i Oslo, Master i informatikk <p>
